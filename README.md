...
Data exploration, helps us to achieve a basic understanding of the chosen data. The results of data exploration can be extremely useful in understanding the structure of the dataset. Descriptive statistics is the process of condensing key characteristics of the data set into simple numeric metrics such as; mean, max and standard deviation etc.
